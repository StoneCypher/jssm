...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    return e;
      ...
      peg$c8 = function peg$c8(chars) {
    return chars.join("");
  },
      peg$c9 = /^[0-9a-fA-F]/,
      peg$c10 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false),
      peg$c11 = "\"",
    ...
    return "\t";
      ...
      peg$c32 = "v",
      peg$c33 = peg$literalExpectation("v", false),
      peg$c34 = function peg$c34() {
    return "\v";
  },
      peg$c35 = "u",
      peg$c36 = peg$literalExpectation("u", false),
      peg$c37 = function peg$c37(digits) {
    return String.fromCharCode(parseInt(digits, 16));
  },
      peg$c38 = function peg$c38(Sequence) {
    return Sequence;
  },
      peg$c39 = /^[ -!#-[\]-\u10FFFF]/,
      peg$c40 = peg$classExpectation([[" ", "!"], ["#", "["], ["]", "\u10FF"], "F", "F"], false, false),
      peg$c41 = peg$otherExpectation("label"),
      peg$c42 = /^[0-9a-zA-Z.+\-_&()%$#@!?<>,:;']/,
      peg$c43 = peg$classExpectation([["0", "9"], ["a", "z"], ["A", "Z"], ".", "+", "-", "_", "&", "(", ")", "%", "$", "#", "@", "!", "?", "<", ">", ",", ":", ";", "'"], false, false),
      peg$c44 = function peg$c44(text) {
    return text.join('');
  },
      peg$c45 = ":",
      ...
      peg$c53 = function peg$c53(ldesc, arrow, rdesc, label, tail) {
    return { kind: arrow, to: label, se: tail === [] ? undefined : tail };
  },
      peg$c54 = function peg$c54(label, se) {
  ...
  function peg$parseDescItems() {
    var s0, s1;

    s0 = [];
    s1 = peg$parseDescItem();
    if (s1 !== peg$FAILED) {
      while (s1 !== peg$FAILED) {
        s0.push(s1);
        s1 = peg$parseDescItem();
...
exports.histograph = exports.rand_select = exports.seq = exports.machine = exports.version = undefined;
...
var version = '1.9.10'; // replaced from package.js in build
