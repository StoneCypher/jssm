 ...
 */
declare type TapeKind = 'input' | 'output' | 'log' | 'error';
/**
 ...
 */
declare type ChannelDirection = 'input' | 'output';
/**
 ...
 */
declare type TapeHistory = number | typeof unlimited;
/**
