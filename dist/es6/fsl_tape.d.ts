 ...
 * @see TapeHistory
 */
declare const unlimited: unique symbol;
/**
 ...
 * @template T - The tape's element type (`tape of T`, §14 "First-class tapes").
 */
type TapeEntry<T> = {
 ...
 * @see Tape
 */
declare function is_retained(kind: TapeKind): boolean;
/**
 ...
 * @template T - The tape's element type.
 * @example
 ...
 * @throws RangeError when constructed with a non-positive, non-integer, or
 *         unsafely large (> `Number.MAX_SAFE_INTEGER`) numeric capacity.
 * @see TapeTransaction
 * @see is_retained
 */
declare class Tape<T> {
     ...
     *         safe integer (zero, negative, fractional, NaN, ±Infinity, or
     *         beyond `Number.MAX_SAFE_INTEGER`).
     */
    constructor(kind: TapeKind, capacity?: TapeHistory);
    /**
 ...
 * @template T - The channel's payload type (its declared alphabet, #1358).
 * @example
 ...
 * @see Channel
 */
declare class TapeTransaction {
    private readonly channels;
    private readonly pipeline;
    private settled_state;
    /**
