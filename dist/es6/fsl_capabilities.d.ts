 ...
 */
declare type CertificationTier = 'T1' | 'T2' | 'T3' | 'adapter';
/**
 ...
 *  compatibility.
 */
declare type FslFeature = 'first_class_lambdas' | 'int256' | 'dense_time' | 'arbitrary_precision' | 'threads' | 'float' | 'double' | 'longint' | 'unbounded_decimal' | 'open_strings' | 'open_containers' | 'recursive_adts' | 'any_dynamic' | 'transitions' | 'actions' | 'forced_transitions' | 'override' | 'tapes' | 'sensors' | 'channels' | 'emit' | 'time' | 'vals' | 'assign' | 'data' | 'rand' | 'probability' | 'rollback' | 'composition' | 'embedding' | 'pinned_unicode' | (string & {});
/**
...
export { CertificationTier, certification_tiers, FslFeature, CapabilityManifest, MachineRequirements, CapabilityCheckResult, make_manifest, make_requirements, check_capabilities, check_capabilities_all };
