 ...
 */
declare const certification_tiers: ReadonlyArray<CertificationTier>;
/**
 ...
 *  compatibility.
 */
type FslFeature = 'first_class_lambdas' | 'int256' | 'dense_time' | 'arbitrary_precision' | 'threads' | 'float' | 'double' | 'longint' | 'unbounded_decimal' | 'open_strings' | 'open_containers' | 'recursive_adts' | 'any_dynamic' | 'transitions' | 'actions' | 'forced_transitions' | 'override' | 'tapes' | 'sensors' | 'channels' | 'emit' | 'time' | 'vals' | 'assign' | 'data' | 'rand' | 'probability' | 'rollback' | 'composition' | 'embedding' | 'pinned_unicode' | (string & {});
/**
 ...
 *  @see check_capabilities
 */
declare function make_manifest(target: string, tier: CertificationTier, supports: Iterable<FslFeature>): CapabilityManifest;
/**
 ...
 *  @see check_capabilities
 */
declare function make_requirements(required: Iterable<FslFeature>): MachineRequirements;
/**
 ...
 *  @see check_capabilities
 */
declare function feature_compare(a: FslFeature, b: FslFeature): -1 | 0 | 1;
/**
 ...
 */
declare function check_capabilities(requirements: MachineRequirements, manifest: CapabilityManifest): CapabilityCheckResult;
/**
 ...
 *  @see check_capabilities
 */
declare function check_capabilities_all(requirements: MachineRequirements, manifests: ReadonlyArray<CapabilityManifest>): ReadonlyArray<CapabilityCheckResult>;
export { CertificationTier, certification_tiers, FslFeature, CapabilityManifest, MachineRequirements, CapabilityCheckResult, make_manifest, make_requirements, feature_compare, check_capabilities, check_capabilities_all };
