 ...
 *
 */
const codata_2018 = Object.freeze({
    c: Object.freeze({ name: 'speed of light in vacuum', value: 299792458, unit: 'm s^-1', uncertainty: 0, codata_year: 2018 }),
    G: Object.freeze({ name: 'Newtonian constant of gravitation', value: 6.6743e-11, unit: 'm^3 kg^-1 s^-2', uncertainty: 1.5e-15, codata_year: 2018 }),
 ...
 */
const physical_constants_by_year = Object.freeze({
    2018: codata_2018
});
/**
 ...
 */
const CONSTANTS_VERSION = `CODATA ${latest_codata_year}`;
/*******
 *
 *  Lookup API.
 *
 ...
 */
function ascending_year_order(a, b) {
    return a - b;
}
/**
 ...
 */
function supported_codata_years() {
    return Object.keys(physical_constants_by_year).map(Number)
 ...
 */
function physical_constant_symbols(year = latest_codata_year) {
    return Object.keys(physical_constants_by_year[year]);
}
/**
 ...
 */
function known_physical_constant(symbol, year = latest_codata_year) {
 ...
 */
function physical_constant(symbol, year = latest_codata_year) {
    const table = physical_constants_by_year[year];
    if (table === undefined) {
 ...
 */
function lookup_constant(symbol) {
...
export { physical_constants_by_year, latest_codata_year, CONSTANTS_VERSION, ascending_year_order, supported_codata_years, physical_constant_symbols, known_physical_constant, physical_constant, lookup_constant, UnknownConstantError, };
