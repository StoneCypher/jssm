...
declare type ReplayErrorKind = 'malformed_tape' | 'unsupported_format_version' | 'unknown_op' | 'source_hash_mismatch' | 'no_pending_timer' | 'parse_error';
