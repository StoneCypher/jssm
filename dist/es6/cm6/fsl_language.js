 ...
 */
export const fslDeprecated = Tag.defineModifier('fslDeprecated');
/**
 ...
 */
export const DEPRECATED_KEYWORDS = new Set([
 ...
 */
export const ENUM_KEYWORDS = new Set([
 ...
 */
export const fslHighlightStyle = HighlightStyle.define([
