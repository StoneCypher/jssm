...
const GCB_RANGES = [
    ...
    [0x0900, 0x0902, GcbClass.Extend],
    [0x093A, 0x093A, GcbClass.Extend],
    [0x093E, 0x0940, GcbClass.SpacingMark],
    [0x0941, 0x0948, GcbClass.Extend],
    [0x1100, 0x115F, GcbClass.L],
    [0x1160, 0x11A7, GcbClass.V],
    [0x11A8, 0x11FF, GcbClass.T],
    [0x200B, 0x200B, GcbClass.Control],
    [0x200D, 0x200D, GcbClass.ZWJ],
    ...
    [0xAC00, 0xD7A3, GcbClass.LVT],
    [0xFE00, 0xFE0F, GcbClass.Extend],
    [0xFEFF, 0xFEFF, GcbClass.Control],
    [0x1F000, 0x1FAFF, GcbClass.Extended_Pictographic],
    [0x1F1E6, 0x1F1FF, GcbClass.Regional_Indicator],
...
function should_break(left, right, ri_run, emoji_zwj) {
    ...
    if (left === GcbClass.Control || left === GcbClass.CR || left === GcbClass.LF) {
        return true;
    }
    if (right === GcbClass.Control || right === GcbClass.CR || right === GcbClass.LF) {
        return true;
    }
    // GB6 / GB7 / GB8: Hangul jamo sequences.
    if (left === GcbClass.L &&
        (right === GcbClass.L || right === GcbClass.V || right === GcbClass.LV || right === GcbClass.LVT)) {
        return false;
    }
