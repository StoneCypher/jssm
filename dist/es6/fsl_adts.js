 ...
 *
 */
function is_variant(value) {
    return (typeof value === 'object')
        && (value !== null)
        && (!Array.isArray(value))
        && (typeof value.adt === 'string')
 ...
 *
 */
function variant_field(value, field) {
    if (!is_variant(value)) {
 ...
 *
 */
function match(value, arms, otherwise) {
    if (!is_variant(value)) {
 ...
 *
 */
function option_unwrap_or(value, fallback) {
 ...
 *
 */
function option_of_nullable(value) {
 ...
 *
 */
function nullable_of_option(value) {
    return is_some(value)
        ? value.fields.value
        : null;
}
 ...
 *
 */
function fn_value(tag, captures = {}) {
    if ((typeof tag !== 'string') || (tag.length === 0)) {
    ...
    return Object.freeze({
        fn: tag,
        captures: deep_freeze_copy(captures)
    });
}
/*******
 *
 ...
 *
 */
function is_fn_value(value) {
    return (typeof value === 'object')
        && (value !== null)
        && (!Array.isArray(value))
        && (typeof value.fn === 'string')
        && (typeof value.captures === 'object')
        && (value.captures !== null)
 ...
 *
 */
function deep_freeze_copy(value) {
    if ((typeof value !== 'object') || (value === null)) {
        return value;
    }
    if (Array.isArray(value)) {
        const copied = value.map(deep_freeze_copy);
...
export { variant, is_variant, variant_tag, variant_field, match, 
// option<T> (§4.4)
