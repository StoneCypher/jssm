 ...
 *
 */
export declare function isIn<mDT>(m: Machine<mDT>, groupName: string): boolean;
/********
 *
 ...
 *
 */
export declare function groupsOf<mDT>(m: Machine<mDT>, state: StateType): Set<string>;
/********
 *
 ...
 *
 */
export declare function groups<mDT>(m: Machine<mDT>): string[];
/********
 *
 ...
 *
 */
export declare function statesIn<mDT>(m: Machine<mDT>, groupName: string): Array<StateType>;
/********
 *
 ...
 *
 */
export declare function groups_by_depth<mDT>(m: Machine<mDT>, state: StateType): string[];
export {};
