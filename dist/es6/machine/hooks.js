...
export const hook_required_fields = {
    'hook': ['from', 'to'],
...
// requirements above.
export const hook_spatial_fields = ['from', 'to', 'action'];
/**
...
function validate_hook_description(m, HookDesc) {
    ...
    if (required === undefined) {
        throw new JssmError(m, `unknown hook kind ${JSON.stringify(HookDesc.kind)}`);
    }
 ...
 *  @see remove_hook
 */
export function set_hook(m, HookDesc) {
    ...
    switch (HookDesc.kind) {
        case 'hook': {
            ...
            m._hooks.set(pair_key(m._state_interner.intern(HookDesc.from), m._state_interner.intern(HookDesc.to)), HookDesc.handler);
            m._has_hooks = true;
        ...
        case 'post hook': {
            ...
            m._post_hooks.set(pair_key(m._state_interner.intern(HookDesc.from), m._state_interner.intern(HookDesc.to)), HookDesc.handler);
 ...
 *  @see set_hook
 */
export function remove_hook(m, HookDesc) {
    let removed = false;
    switch (HookDesc.kind) {
        case 'hook': {
            // id_of, not intern: removal of an unknown name reports false and
            // must not grow the interner tables (#729).
            const fid = m._state_interner.id_of(HookDesc.from), tid = m._state_interner.id_of(HookDesc.to);
            removed = (fid !== undefined) && (tid !== undefined) && m._hooks.delete(pair_key(fid, tid));
            break;
        }
        case 'named': {
            const fid = m._state_interner.id_of(HookDesc.from), tid = m._state_interner.id_of(HookDesc.to), aid = m._action_interner.id_of(HookDesc.action);
        ...
        default: {
            throw new JssmError(m, `Unknown hook type ${HookDesc.kind}, should be impossible`);
        }
    }
    if (removed) {
...
function recompute_hook_flags(m) {
    const nested_has = (table) => [...table.values()].some(inner => inner.size > 0);
 ...
 *  @see post_hook
 */
export function hook(m, from, to, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_action(m, from, to, action, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_global_action(m, action, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_any_action(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_standard_transition(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_main_transition(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_forced_transition(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_any_transition(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_entry(m, to, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_exit(m, from, handler) {
 ...
 */
export function hook_after(m, from, handler) {
 ...
 *  @see set_state_timeout
 */
export function hook_after_any(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook(m, from, to, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_action(m, from, to, action, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_global_action(m, action, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_any_action(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_standard_transition(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_main_transition(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_forced_transition(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_any_transition(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_entry(m, to, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function post_hook_exit(m, from, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_pre_everything(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_everything(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_post_everything(m, handler) {
 ...
 *  @returns The machine, for chaining.
 */
export function hook_pre_post_everything(m, handler) {
 ...
 *
 */
export function hook_registry(m) {
    const entries = [];
 ...
 *
 */
export function hooks_on(m, query) {
 ...
 *
 */
export function has_hook(m, query, phase) {
 ...
 *
 */
export function state_has_hooks(m, state) {
 ...
 */
export function is_hook_complex_result(hr) {
 ...
 *  @internal
 */
export function update_hook_fields(hook_args, res) {
 ...
 */
export function is_hook_rejection(hr) {
    if (hr === true) {
        return false;
    }
    if (hr === undefined) {
 ...
 *  @internal
 */
export const HOOK_PASSED = Object.freeze({ pass: true });
export const HOOK_REJECTED = Object.freeze({ pass: false });
/**
 *
 ...
 *  @internal
 */
export function abstract_hook_step(maybe_hook, hook_args) {
 ...
 *  @internal
 */
export function abstract_everything_hook_step(maybe_hook, hook_args) {
    if (maybe_hook === undefined) {
        return HOOK_PASSED;
    }
    const result = maybe_hook(hook_args);
