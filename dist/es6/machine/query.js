 ...
 *
 */
export function label_for(m, state) {
 ...
 *
 */
export function display_text(m, state) {
    var _a;
    return (_a = m._state_labels.get(state)) !== null && _a !== void 0 ? _a : state;
}
/********
 *
 ...
 *
 */
export function is_start_state(m, whichState) {
 ...
 *
 */
export function is_end_state(m, whichState) {
 ...
 *
 */
export function failed_outputs(m) {
 ...
 *
 */
export function is_failed_output(m, whichState) {
 ...
 *
 */
export function state_is_final(m, whichState) {
 ...
 */
export function machine_author(m) {
 ...
 */
export function machine_comment(m) {
 ...
 */
export function machine_contributor(m) {
 ...
 */
export function machine_definition(m) {
 ...
 */
export function machine_language(m) {
 ...
 */
export function machine_license(m) {
 ...
 */
export function machine_name(m) {
 ...
 */
export function editor_config(m) {
 ...
 *  @see npm_name
 */
export function default_size(m) {
 ...
 *  @see fsl_version
 */
export function machine_version(m) {
 ...
 */
export function raw_state_declarations(m) {
 ...
 */
export function state_declaration(m, which) {
 ...
 */
export function state_declarations(m) {
 ...
 */
export function machine_state(m) {
    return {
 ...
 */
export function state_for(m, whichState) {
 ...
 *
 */
export function has_state(m, whichState) {
 ...
 */
export function list_named_transitions(m) {
 ...
 */
export function list_actions(m) {
 ...
 */
export function uses_actions(m) {
 ...
 */
export function uses_forced_transitions(m) {
 ...
 *
 */
export function code_allows_override(m) {
 ...
 *
 */
export function config_allows_override(m) {
 ...
 *
 */
export function allows_override(m) {
 ...
 *
 */
export function allow_islands(m) {
 ...
 */
export function all_state_name_chars(m) {
 ...
 */
export function all_state_name_first_chars(m) {
 ...
 */
export function all_action_label_chars(m) {
 ...
 */
export function get_transition_by_state_names(m, from, to) {
 ...
 */
export function lookup_transition_for(m, from, to) {
 ...
 *
 */
export function list_transitions(m, whichState = state(m)) {
 ...
 *
 */
export function list_entrances(m, whichState = state(m)) {
    var _a, _b;
    const guaranteed = ((_a = m._states.get(whichState)) !== null && _a !== void 0 ? _a : { from: undefined });
 ...
 *
 */
export function list_exits(m, whichState = state(m)) {
    var _a, _b;
    const guaranteed = ((_a = m._states.get(whichState)) !== null && _a !== void 0 ? _a : { to: undefined });
 ...
 *
 */
export function actions(m, whichState = state(m)) {
 ...
 *
 */
export function list_states_having_action(m, whichState) {
 ...
 */
export function list_exit_actions(m, whichState = state(m)) {
 ...
 *  @throws {JssmError} If the state does not exist.
 */
export function probable_action_exits(m, whichState = state(m)) {
    const ra_base = m._reverse_actions.get(whichState);
    if (!(ra_base)) {
        if (has_state(m, whichState)) {
            return [];
 ...
 *  @throws {JssmError} If the state does not exist.
 */
export function is_unenterable(m, whichState) {
    if (!(has_state(m, whichState))) {
 ...
 */
export function has_unenterables(m) {
 ...
 *  @throws {JssmError} If the state does not exist.
 */
export function state_is_terminal(m, whichState) {
    if (!(has_state(m, whichState))) {
        throw new JssmError(m, `No such state ${whichState}`);
    }
 ...
 */
export function has_terminals(m) {
 ...
 *  @throws {JssmError} If the state does not exist.
 */
export function state_is_complete(m, whichState) {
 ...
 */
export function has_completes(m) {
 ...
 */
export function edges_between(m, from, to) {
    var _a;
    ...
    const outbound = (_a = m._outbound_edge_ids.get(from)) !== null && _a !== void 0 ? _a : [];
    const result = [];
 ...
 */
export function current_action_for(m, action) {
 ...
 */
export function current_action_edge_for(m, action) {
