 ...
 *
 */
export function find_connected_components(states, edges) {
 ...
 *
 */
export function new_state(m, state_config) {
 ...
 *
 */
export function serialize(m, comment) {
    return {
        comment,
        state: m._state,
        data: m._data,
 ...
 */
export function instance_name(m) {
 ...
 */
export function creation_date(m) {
 ...
 */
export function creation_timestamp(m) {
    return m._created;
}
/**
 ...
 */
export function create_start_time(m) {
