 ...
 *
 */
declare class MicrostepOverflowError<Config> extends Error {
 ...
 *
 */
declare function resolve_bound(bound: number | 'unbounded' | undefined): number;
/*******
 *
 ...
 *
 */
declare function settle_microsteps<Config>(step: StepFn<Config>, initial: Config, options?: SchedulerOptions<Config>): MacrostepResult<Config>;
/*******
 *
 ...
 *
 */
declare function run_macrostep<Config>(step: StepFn<Config>, initial: Config, options?: SchedulerOptions<Config>): MacrostepResult<Config>;
/*******
 *
 ...
 *
 */
declare function is_stable<Config>(step: StepFn<Config>, config: Config): boolean;
export { default_microstep_bound, MicrostepOverflowError, resolve_bound, settle_microsteps, run_macrostep, is_stable };
export type { StepResult, StepFn, SchedulerOptions, MacrostepResult };
