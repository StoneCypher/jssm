 ...
 *
 */
declare const fsl_error_kinds: readonly ["div_by_zero", "out_of_bounds", "overflow", "underflow", "type_error", "failed_narrow", "contract_violation", "unbound_value", "nan_compare", "microstep_overflow"];
/**
 ...
 *  {@link FslError}.
 */
declare type FslErrorKind = (typeof fsl_error_kinds)[number];
/**
 ...
 */
declare type FslContractKind = 'require' | 'ensure' | 'invariant';
/*******
 *
 ...
 */
declare type FslErrorInfo = FslErrorFields & {
    kind: FslErrorKind;
};
/*******
 *
 ...
 *
 */
declare function describe_fields(fields: FslErrorFields): string;
/*******
 *
 ...
 *
 */
declare class FslError extends Error {
    kind: FslErrorKind;
    base_message: string;
    message: string;
 ...
 *  // FslError: div_by_zero: division by zero (entity "rate")
 */
declare function div_by_zero_error(entity?: string, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function out_of_bounds_error(entity: string, index: number, length: number, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function overflow_error(entity: string, value: number, upper_bound: number, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function underflow_error(entity: string, value: number, lower_bound: number, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function type_error(expected_type: string, actual_type: string, entity?: string, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function failed_narrow_error(expected_type: string, actual_type: string, entity?: string, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function contract_violation_error(contract: FslContractKind, entity: string, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function unbound_value_error(entity: string, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function nan_compare_error(entity?: string, source_location?: FslSourceLocation): FslError;
/**
 ...
 */
declare function microstep_overflow_error(bound: number, source_location?: FslSourceLocation): FslError;
export { fsl_error_kinds, FslErrorKind, FslContractKind, FslErrorFields, FslErrorInfo, describe_fields, FslError, div_by_zero_error, out_of_bounds_error, overflow_error, underflow_error, type_error, failed_narrow_error, contract_violation_error, unbound_value_error, nan_compare_error, microstep_overflow_error, };
