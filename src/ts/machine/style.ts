...
import type {
  JssmStateConfig, JssmStateDeclaration, JssmStateDeclarationRule, JssmStateStyleKeyList,
  JssmTransitionConfig, JssmGraphConfig,
  FslTheme, FslDirection, JssmBaseTheme
} from '../jssm_types.js';
...
export function transfer_state_properties(state_decl: JssmStateDeclaration): JssmStateDeclaration {
 ...
 */
export function graph_layout<mDT>(m: Machine<mDT>): string {
 ...
 */
export function dot_preamble<mDT>(m: Machine<mDT>): string {
 ...
 */
export function default_transition_config<mDT>(m: Machine<mDT>): JssmTransitionConfig | undefined {
 ...
 */
export function default_graph_config<mDT>(m: Machine<mDT>): JssmGraphConfig | undefined {
 ...
 */
export function all_themes<mDT>(m: Machine<mDT>): FslTheme[] {
 ...
 */
export function themes<mDT>(m: Machine<mDT>): FslTheme | FslTheme[] {
 ...
 */
export function set_themes<mDT>(m: Machine<mDT>, to: FslTheme | FslTheme[]): void {
 ...
 */
export function flow<mDT>(m: Machine<mDT>): FslDirection {
  return m._flow;
}
...
export function standard_state_style<mDT>(m: Machine<mDT>): JssmStateConfig {
...
export function hooked_state_style<mDT>(m: Machine<mDT>): JssmStateConfig {
...
export function start_state_style<mDT>(m: Machine<mDT>): JssmStateConfig {
...
export function end_state_style<mDT>(m: Machine<mDT>): JssmStateConfig {
...
export function terminal_state_style<mDT>(m: Machine<mDT>): JssmStateConfig {
...
export function active_state_style<mDT>(m: Machine<mDT>): JssmStateConfig {
...
function resolved_themes<mDT>(m: Machine<mDT>): JssmBaseTheme[] {
...
function individual_state_config<mDT>(m: Machine<mDT>, state: StateType): JssmStateConfig {

  const decl: JssmStateDeclaration = m._state_declarations.get(state);
...
function compose_state_config<mDT>(m: Machine<mDT>, state: StateType, active: boolean): JssmStateConfig {

  const themes: JssmBaseTheme[] = resolved_themes(m);
  ...
  for (const group_name of groups_by_depth(m, state)) {
    const group_cfg: JssmStateConfig | undefined = m._group_metadata.get(group_name);
...
export function resolve_state_config<mDT>(m: Machine<mDT>, state: StateType): JssmStateConfig {
  ...
  if (m._state === state) {
    const acc: JssmStateConfig = compose_state_config(m, state, true);
  ...
  const cached: JssmStateConfig | undefined = m._static_state_config_cache.get(state);
  if (cached !== undefined) { return cached; }

  const resolved: JssmStateConfig = compose_state_config(m, state, false);
...
export function style_for<mDT>(m: Machine<mDT>, state: StateType): JssmStateConfig {
