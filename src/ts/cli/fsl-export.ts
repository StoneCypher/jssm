import { cli } from './subcommands/export/plugin';

/**
 * Binary entry for `fsl-export`. Calls the plugin's `cli()` function and
...
async function main(): Promise<void> {
  // process.argv shape: ['node', '/path/to/fsl-export.cjs', ...userArgs]
