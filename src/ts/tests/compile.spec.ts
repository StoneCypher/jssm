...
describe('compile/1', () => {
  ...
  describe('direct make callpoint', () => {
    const match = { start_states: [ 'a' ], end_states: [], failed_outputs: [], transitions: [ { from: 'a', to: 'b', kind: 'legal', after_time: undefined, forced_only: false, main_path: false, action: undefined, probability: undefined, share: undefined } ], state_property: [] };
    test('direct match', () => {
