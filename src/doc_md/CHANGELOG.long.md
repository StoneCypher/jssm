...
## [Untagged] - Jun 5, 2026 9:28:48 PM

Commit [a2970f59bc6ae6d35eaea5de8b1853495d8d86da](https://github.com/StoneCypher/jssm/commit/a2970f59bc6ae6d35eaea5de8b1853495d8d86da)

Author: `John Haugeland <stonecypher@gmail.com>`

  * chore(release): v5.141.12 — jest/vitest cleanup, plan + closure-doc removal
  * Bundles the jest->vitest migration-residue cleanup and notes pruning into a real release so it isn't a no-op publish:
  * - jest->vitest residue (from prior commits on this branch): ci_profile.cjs phase names, five @jest-environment -> @vitest-environment test pragmas, and the editor-widget spec's Rollup-not-Vite correction
- removed the completed lit-wc-foundation plan (shipped via #603)
- removed the parked issues-recommended-for-closure.md (deferred-deletion plan: ride a real release, not a no-op)
- regenerated all tracked artifacts via npm run build (dist, docs, changelog, readme, cloc, custom-elements.json)
...
## [Untagged] - Jun 5, 2026 8:59:58 PM

Commit [04ef369639a7eaeb4a6790d02f6a3e04f56f7ef6](https://github.com/StoneCypher/jssm/commit/04ef369639a7eaeb4a6790d02f6a3e04f56f7ef6)

Author: `John Haugeland <stonecypher@gmail.com>`

Merges [d02a38bd, 3fd893e8]

  * On feat_26-06-05_graviton-fire-after-publish: parked during graviton release (other-instance + user edits)
...
Commit [3fd893e8144e1ccd99a22e4516fe5749ec958958](https://github.com/StoneCypher/jssm/commit/3fd893e8144e1ccd99a22e4516fe5749ec958958)

Author: `John Haugeland <stonecypher@gmail.com>`

  * index on feat_26-06-05_graviton-fire-after-publish: d02a38bd docs: AWS setup for the CI graviton benchmark (OIDC role, instance profile, SSM PAT)
...
## [Untagged] - Jun 5, 2026 8:29:32 PM

Commit [9242ed3b6cf43b53019966e0017c2699776b278d](https://github.com/StoneCypher/jssm/commit/9242ed3b6cf43b53019966e0017c2699776b278d)

Author: `John Haugeland <stonecypher@gmail.com>`

  * docs(notes): correct drifted issue numbers in fsl closure list
  * The fsl-issues.json snapshot had off-by-one numbers for three entries; fixed by finding the issue that actually bears each title rather than rewriting the title: #357->#358, #381->#382, #393->#394 (all OPEN). Removed a phantom '#21 ToHTML duplicate' row (no second ToHTML issue exists; live #21 is the unrelated, closed 'Move FSLi issues here'). Tier 1 count 13->12, total ~48->~47.
...
Commit [3e7f40e9c4b8a69f7b5f9f05587ee1d69321b23c](https://github.com/StoneCypher/jssm/commit/3e7f40e9c4b8a69f7b5f9f05587ee1d69321b23c)
