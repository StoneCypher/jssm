...
const body = inline_fail_guard(inline_arrowtarget_gates(inline_fast_string(inline_fast_actionlabel(inline_fast_integer(inline_fast_atom(inline_fast_ws(widened)))))));
