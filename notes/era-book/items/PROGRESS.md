...
### MILESTONE: full W-item + program-topic spine seeded (271 items, all 12 versions)
Remaining work per the plan: the **e1–e7 tracker-row residue** (non-W-twin rows: perf levers, viz/theme/editor QoL, serialize details, CLI-verb twins for v7–v10; e2–e7 rows for v11–v16) as a subagent-parallelized sweep, then wire the **per-era Mermaid diagram** into `era_book_html.cjs` (edges now exist across all eras).
 (abi-migration W11.1,WP15.1; per-host-runtimes W11.2; codegen-adapters W11.3; fleet-certification W11.4,9; typegen-manifests-wasm W11.5–8,10) — host ABI freeze + org migration, bringup kit, T2/T3 differential fleet CI, codegen/adapters, fleet typegen + manifests + WASM + publish. issue-twins W11.3=563, W11.4=815, W11.7=1172, W11.10=407. `npm run era_book` green (261 files). **Era 6 (v15) W-spine COMPLETE.**
