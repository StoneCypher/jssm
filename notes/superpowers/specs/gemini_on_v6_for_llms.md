...
*   **Data-Flow / Taint Tracking Verification:** Testing that a specific payload value provided at State A (e.g., a user's Personally Identifiable Information) is preserved, unmodified, and formally proven never to be leaked to State Z (e.g., an external logging telemetry state).
