...
Graphviz-based visualization for [jssm](https://github.com/StoneCypher/jssm)
state machines — renders finite state machines to SVG, PNG, and JPEG.

```
npm install jssm-viz
```
...
[github.com/StoneCypher/jssm](https://github.com/StoneCypher/jssm).
