// jssm-cjs compatibility package — the CommonJS build, sequestered out of the
...
// `jssm-cjs`.  That is the cost of the split: a consumer downloads one format
...
export default [

  {
    ...
    output : { file: 'packages/jssm-cjs/dist/jssm.cjs', format: 'cjs', name: 'jssm', exports: 'named' },
    plugins: [
      nodeResolve({
  ...
  //  because it is the CJS surface it documents.
  {
    ...
    output : { file: 'packages/jssm-cjs/dist/jssm.d.cts', format: 'cjs' },
    plugins: [dts()],
  },
