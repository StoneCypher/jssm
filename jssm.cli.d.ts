 ...
 */
type CodegenTarget = 'native:typescript' | 'native:javascript';
/**
...
type CodegenSetItem = CodegenSetItemOk | CodegenSetItemErr;
/**
 ...
 */
type ExportFormat = 'json' | 'mermaid' | 'scxml' | 'xstate' | 'dot' | 'tla+' | 'alloy' | 'smv' | 'promela' | 'gbnf' | 'lark' | 'ebnf';
/**
 ...
 */
type ImportFormat = 'json' | 'mermaid' | 'scxml' | 'xstate' | 'dot';
/**
...
type RenderTargetName = RenderTarget;
 ...
 */
type RegistryConfig = Record<string, string>;
...
type FlagMapping = Record<string, string | null>;
/**
